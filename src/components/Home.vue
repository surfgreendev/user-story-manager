...
<div class="wrapper">
    ...
    <div class="container-fluid container__back">
        <div class="container">
            <div class="row cm__box cm__box--faq">
                <div class="col-xs-12">
                <br><br>
                    <div class="text-xs-center cm__box__faq--hd">
                        <h2>Frequently Asked Questions</h2>
                        <hr class="hr-content--inverse">
                        <h3>Here are answers to the most asked questions about LEYLA</h3>
                    </div>

                    <dl class="row dl__faq">
                        ...
                        <dd class="col-sm-9 lead">Behind LEYLA stands a small team of experienced product managers & product owners and software engineers with +8 years of experience in e-commerce, digital advertising and really large relaunch projects. </dd>
